...
exports.OkexPerpetualBtcUsdt = void 0;
...
class OkexPerpetualBtcUsdt extends extractor_1.Extractor {
    constructor() {
        super(...arguments);
        this.mid = 'okex-perpetual-btc-usdt';
    ...
    normalizeRawOrderbook(rawOrderbook) {
        return {
            [interfaces_1.Side.ASK]: rawOrderbook.asks.map(rawOrder => normalizeRawOrder(rawOrder, interfaces_1.Side.ASK)),
...
exports.OkexPerpetualBtcUsdt = OkexPerpetualBtcUsdt;
//# sourceMappingURL=okex-perpetual-btc-usdt.js.map